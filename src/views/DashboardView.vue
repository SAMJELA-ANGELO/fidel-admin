        ...
        <div class="card-content">
          ...
          <div v-else-if="recentOrders.length === 0" class="empty-orders">
            ...
            <div class="empty-actions">
              <router-link to="/create-product" class="btn btn-primary btn-sm">
                <svg
                  class="btn-icon"
                  fill="none"
                  stroke="currentColor"
  ...
  setup() {
    ...
    const fetchStats = async () => {
      try {
        ...
        // Show up to 5 most recent orders, sorted by createdAt date
        recentOrders.value = Array.isArray(orders)
          ? orders
              .sort(
                (a, b) =>
