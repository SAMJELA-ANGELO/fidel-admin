...
import { getProductCount, getOrderCount, getCategoryCount } from "../api";
  ...
  setup(props) {
    ...
    const fetchCounts = async () => {
      try {
        ...
        productCount.value = productRes.data.count;
        orderCount.value = orderRes.data.count;
        categoryCount.value = categoryRes.data.count;
      } catch (error) {
    ...
    // Watch for sidebar open state to refresh counts
    watch(
      () => props.isOpen,
      (newVal) => {
        if (newVal) {
